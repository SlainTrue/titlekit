...
module Titlekit
  module VTT
    ...
    #
    # @param string [String] proper UTF-8 WEBVTT file content
    # @return [Array<Hash>] the imported subtitles
    def self.import(string)
      Treetop.load(File.join(__dir__, 'vtt'))
    ...
    # Exports the supplied subtitles to WEBVTT format
    #
    # @param subtitles [Array<Hash>] The subtitle to export
    # @return [String] Proper UTF-8 WEBVTT as a string
    ...
    # Builds an WEBVTT-formatted timecode from a float representing seconds
    #
    # @param seconds [Float] an amount of seconds
    # @return [String] An WEBVTT-formatted timecode ('hh:mm:ss.ms')
    ...
    # Parses an WEBVTT-formatted timecode into a float representing seconds
    #
    # @param timecode [String] An WEBVTT-formatted timecode ('hh:mm:ss.ms')
